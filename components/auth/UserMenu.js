...
export default function UserMenu() {
  ...
  // Only show UserMenu when fully authenticated (user + GitHub token).
  // When logged out or when token has expired, we show nothing here so the
  // LoginButton is the only auth control (no "Reconnect" with username).
