            ...
            >
              <ul className="flex flex-col">
                ...
                <li className="border-b border-light-100 dark:border-dark-600 h-10 px-3 flex group">
                  <Link href="/changelog" className="flex items-center font-normal no-underline w-full h-full text-dark-400/80 dark:text-light-300 dark:hover:text-white transition-all duration-150 ease-in-out hover:text-dark-700 gap-x-2">
                      <svg
                        className="w-5 h-5"
                        fill="none"
                        stroke="currentColor"
      ...
      <main>
        ...
        >
          <ul className="menu mb-auto">
            ...
            />
            <li>
              <Link href="/" className="px-6 mb-auto mt-4 flex items-center text-xs text-brand hover:text-white no-underline">
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
