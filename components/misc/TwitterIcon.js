...
const TwitterIcon = () => {
  return (
    ...
    >
      <svg viewBox="0 0 128 128" className="w-5 h-5 group mt-auto">
        <path
          ...
          className="fill-white opacity-70 group-hover:opacity-100 transition-all duration-150 ease-in-out"
        ></path>
      </svg>
    </a>
  );
