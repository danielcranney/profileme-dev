                    ...
                    >
                        {!state.introduction.name ? null : (
                            <div>
                                ...
                                {state.introduction.animatedHand != 0 &&
                                    <h1>Hi <span><img style={{display: 'inline'}} height={'36px'} width={'36px'}
                                                      src={'https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif'}/></span>
                                        My name is {state.introduction.name}</h1>}
                            </div>
                        )}
                        {state.introduction.shortDescription ? (
